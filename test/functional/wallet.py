...
class WalletTest(OakcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 OAK from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 oak in block rewards plus fees, but
        ...
        # Send 10 OAK with subtract fee from amount
        ...
        # Sendmany 10 OAK with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/oakcoin/oakcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
