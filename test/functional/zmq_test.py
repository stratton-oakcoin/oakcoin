...
class ZMQTest (OakcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that oakcoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            self.log.warning("oakcoind has not been built with zmq enabled. Skipping zmq tests!")
            sys.exit(self.TEST_EXIT_SKIPPED)
