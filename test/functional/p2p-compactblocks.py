...
# TestNode: A peer we use to send messages to oakcoind, and store responses.
...
class CompactBlocksTest(OakcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes oakcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that oakcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for oakcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # oakcoind will not send blocktxn responses for blocks whose height is
