Oakcoin Core version 0.13.2 is now available from:

  <https://oakcoin.org/bin/oakcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update oakcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow oakcoin-tx to create v2 transactions (oakdrak)
