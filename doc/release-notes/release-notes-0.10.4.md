Oakcoin Core version 0.10.4 is now available from:

  <https://oakcoin.org/bin/oakcoin-core-0.10.4/>
...
- #6953 `43c2789` Split oakcoin-tx into its own package
- #6953 `dfe0d4d` Include oakcoin-tx binary on Debian/Ubuntu
