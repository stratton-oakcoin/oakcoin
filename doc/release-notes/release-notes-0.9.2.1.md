Oakcoin Core version 0.9.2.1 is now available from:

  https://oakcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OAK to 0.01 OAK
...
- Fix "Start oakcoin on system login"
