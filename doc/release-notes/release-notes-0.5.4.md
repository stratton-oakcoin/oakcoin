Oakcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/oakcoin/files/Oakcoin/oakcoin-0.5.4/
...
http://gitorious.org/oakcoin/oakcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Oakcoin-Qt notifications under Growl 1.3.
Increase required age of Oakcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOakcoin properly when installing Oakcoin-Qt over it. (Windows)
