Oakcoin Core version 0.9.4 is now available from:

  https://oakcoin.org/bin/0.9.4/
...
this update is incompatible with the Oakcoin system and could lead to consensus
forks.

Oakcoin Core released binaries from https://oakcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~oakcoin/+archive/ubuntu/oakcoin
- A third-party or self-compiled Oakcoin Core

upgrade to Oakcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
