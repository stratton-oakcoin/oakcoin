Oakcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/oakcoin/files/Oakcoin/oakcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Oakcoin
...
New/changed settings (command-line or oakcoin.conf file)
--------------------------------------------------------
