...
This document provides guidelines for internationalization of the Oakcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `oakcoin_en.ts` remains unchanged.
