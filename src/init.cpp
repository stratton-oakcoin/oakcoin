 ...
 * between oakcoind, and oakcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/oakcoin/oakcoin>";
    const std::string URL_WEBSITE = "<https://oakcoincore.org>";
...
/** Sanity checks
 *  Ensure that Oakcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Oakcoin process is using the data directory.
