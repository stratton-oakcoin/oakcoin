...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, OakcoinUnits::SeparatorStyle separators=OakcoinUnits::separatorStandard) const;
