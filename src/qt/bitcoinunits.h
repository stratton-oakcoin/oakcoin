...
/** Oakcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OakcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OakcoinUnits(QObject *parent);

    /** Oakcoin units.
      @note Source: https://en.oakcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        OAK,
...
typedef OakcoinUnits::Unit OakcoinUnit;
