...
#if defined(NDEBUG)
# error "Oakcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Oakcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s OAK additional fees, %d delta bytes\n",
