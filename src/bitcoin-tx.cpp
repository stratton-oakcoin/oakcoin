...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s oakcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  oakcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oakcoin transaction") + "\n" +
              "  oakcoin-tx [options] -create [commands]   " + _("Create hex-encoded oakcoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    COakcoinAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        COakcoinAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded oakcoin transaction
