...
unlocked to sign the Oakcoin-Qt.app bundle.
...
allowing somebody to distribute a Oakcoin-Qt.app or oakcoin-qt-setup.exe with a valid
...
that the oakcoin-qt.exe file inside the installer had not been tampered with.
